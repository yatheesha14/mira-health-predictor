...
#Layout 
 ...
 # Scrollable body
       ...
       # Personal section 
        section_label(body, " Personal Information", row=0)
        ...
        #Blood test section
        section_label(body, "Blood Test Results", row=6)
        ...
        tk.Label(body, text=hint, bg=CLR["surface"], fg=CLR["muted"],
                 font=FONT_SMALL).grid(row=10, column=0, columnspan=3,
                                       sticky="w", pady=(4, 0))
        #AI Remarks section
        section_label(body, " AI Health Prediction (Remarks)", row=11)
        ...
        btn_row.grid(row=16, column=0, columnspan=3, sticky="0", pady=(16,8))
